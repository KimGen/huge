...
return array(
    ...
    "FEEDBACK_USERNAME_OR_PASSWORD_WRONG" => "El nombre de usuario o la contraseña es incorrecta.",
    "FEEDBACK_USER_DOES_NOT_EXIST" => "Este usuario no existe.",
    "FEEDBACK_LOGIN_FAILED" => "Login failed.",
    "FEEDBACK_LOGIN_FAILED_3_TIMES" => "Usted ha ingresado mal la contraseña 3 veces, espere 30 segundo para reintentar.",
    ...
    "FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Su cuenta ha digo creada y hemos enviado un email para ud. Por favor, haga click en el LINK DE VERIFICACIÓN adjunto en su email.",
    ...
    "FEEDBACK_VERIFICATION_MAIL_SENDING_SUCCESSFUL" => "Un email de verificación ha sido enviado, revise su correo electrónico.",
