...
class PacientesModel
{
    ...
    public static function getPaciente($paciente_rut)
    {
        ...
        $sql = "SELECT user_id, paciente_rut, paciente_nombre, paciente_apellido, paciente_email, paciente_nacimiento, paciente_prevision, paciente_nacionalidad, paciente_region FROM pacientes WHERE user_id = :user_id AND paciente_rut = :paciente_rut LIMIT 1";
        $query = $database->prepare($sql);
