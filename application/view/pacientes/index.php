    ...
    <div class="row">
        <div class="col-5">
            <div class="btn-group m-3" role="group">
                <button type="button" class="btn btn-outline-primary bg-light btn-lg" id="button.paciente.nuevo"><i class="fas fa-plus"></i> Nuevo Paciente</button>
                <button type="button" class="btn btn-outline-primary bg-light btn-lg d-none" id="button.paciente.guardar"><i class="fas fa-save"></i> Guardar Paciente</button>
                <button type="button" class="btn btn-outline-primary bg-light btn-lg d-none" id="button.paciente.cancelar"><i class="fas fa-ban"></i> Cancelar</button>
                <button type="button" class="btn btn-outline-primary bg-light btn-lg" id="button.paciente.buscar"><i class="fas fa-search"></i> Buscar</button>
                <div class="btn btn-outline-primary btn-lg bg-light d-none" id="interface.paciente.buscar"><input type="text" class="form-control" id="busqueda.pacientes" placeholder="buscar por rut o apellido"></div>
            </div>
        </div>
        <div class="col-7">
